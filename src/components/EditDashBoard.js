...
function EditDashBoard(props) {
    ...
    async function handleSubmitClick(formValues) {
        ...
        var baseURL = 'https://www.janathads.com/api/user-update/' + loggedInUserId + '/'
        await axios
    ...
    const axiosUserDetailResponse = async () => {
        await axios.get('https://www.janathads.com/api/user-detail/' + loggedInUserId)
            .then((adsResponse) => {
            ...
            {(formik) => {
                return (
                    <div id="task-container" className="container py-5">
                        <h4 className="linetitle mb-4">Edit User Profile</h4>
                        <Form>
                            <div className="row">
                                <div className="col-md-8">
                                    ...
                                    <div style={{ flex: 2 }} className="form-group">
                                        <button onClick={handleCacelClick} className="btn btn-secondary mr-3">Cancel</button>
